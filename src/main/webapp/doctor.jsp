...
<button type="button y" class="btn12"><a href="viewpatient.jsp">View Patients</a></button><br><br>
<button type="button y" class="btn12"><a href="PatientDetails.jsp">View Patients Details</a></button><br><br>
</div>
