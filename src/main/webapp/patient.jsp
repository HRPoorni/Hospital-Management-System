...
<button type="button y" class="btn12"><a href="appointment.jsp">Channel a Doctor</a></button><br><br>
<button type="button y" class="btn12"><a href="test.jsp">Test Application</a></button><br><br>
</div>
