...
<title>Product/Services-Solo Music Center</title>
    ...
    <link rel="stylesheet" type = "text/css" href="styles/test.css?v=<?php echo time(); ?>" >
...
<header> 
   ...
   <div class = "col12">       
               <form method="POST" action="AddtestServlet" >
                   <h1 class="alert-success"> Test Area </h1> 
 <% 
           ...
           String sql="select Test_ID,T_Name,T_Rec,T_Des from test;"; //view 
           ...
           while(rst.next())
           {
        	   ...
        	   String name=rst.getString("T_Name");
        	   String rec=rst.getString("T_Rec");
        	   String des=rst.getString("T_Des");
           %>
