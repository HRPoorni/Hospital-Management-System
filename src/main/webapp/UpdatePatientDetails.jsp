 ...
 <!-- ----LOGIN---- -->
  ...
  <main>
    <section class="container wrapper">
      <h2 class="display-4 pt-3">Update Patient Details</h2>
          <%
...
%>
          <form action="UpdatePatientDetailsServlet" method="POST">
          <table>
          <tr><td>Appointment ID</td><td><input type="text" name="id" value="<%=id %>" readonly="readonly"></td></tr>
          <tr><td>Patient ID</td><td><input type="text" value="<%=pid %>"  name="pid" ></td></tr>
             <tr><td>Details</td><td><input type="text" value="<%=pde %>" name="pde" ></td></tr>
