<%@page import="Servlets.UpdatePatientDetailsServlet"%>
...
if(request.getParameter("id")!=null)
{
	   ...
	   ps=con.prepareStatement("delete from patientdet where Det_ID="+id+";");
	   ps.executeUpdate();
}
...
if(request.getParameter("idu")!=null )
{
	   ...
	   PreparedStatement ps;
	   String sql="update patientdet set P_ID='"+pid+"',P_details='"+pde+"' where Det_ID="+id+" ";
 ...
 <!-- ----LOGIN---- -->
  ...
  <main>
    <section class="container wrapper">
      <h2 class="display-4 pt-3">Patient Details</h2>
          ...
          <form method="POST">
           ...
           <%
           Connection con=DB.getConnection();
           String sql="select * from patientdet;";
           ...
           while(rst.next())
           {
        	   String id=rst.getString("Det_ID");
        	   String pid=rst.getString("P_ID");
        	   String pde=rst.getString("P_details");
           %>
           ...
           <td><%= pid %></td>
           <td><%= pde %></td>
           <td><a href="PatientDetails.jsp?id=<%= id%>">Delete</a></td>
           <td><a href="UpdatePatientDetails.jsp?idu=<%= id%>&pid=<%= pid%>&pde=<%= pde%>">Update</a></td>
           </tr>
           <%
           }
